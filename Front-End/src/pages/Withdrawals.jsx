...
function WithdrawalForm({ initial, onSubmit, onClose, loading, apiErrors = {} }) {
  ...
  const validate = () => {
    ...
    if (!form.withdrawal_datetime) errs.withdrawal_datetime = ' Withdrawal Date is required.'
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg">
        ...
        <form onSubmit={submit} className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-700 mb-1.5">Withdrawal Date <span className="text-red-500">*</span></label>
              <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-white via-blue-50/40 to-white p-5">
            ...
            <div className="relative flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <p className="text-sm text-gray-600 truncate">{withdrawal.client_name || '—'}</p>
                <div className="mt-1.5 flex items-center gap-2">
                  <Hash size={13} className="text-gray-900" />
                  <span className="text-lg font-bold text-gray-900 tracking-wide">{withdrawal.client_arc_id || '—'}</span>
                </div>
              </div>
