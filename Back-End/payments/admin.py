...
class QRCodeAdmin(admin.ModelAdmin):
    list_display = ['qr_name', 'brand', 'range_from', 'range_to', 'is_active', 'created_by', 'created_at']
...
class UPISourceAdmin(admin.ModelAdmin):
    list_display = ['upi_id', 'brand', 'range_from', 'range_to', 'is_active', 'created_by', 'created_at']
    list_filter = ['brand', 'is_active']
...
class BankAccountAdmin(admin.ModelAdmin):
    list_display = [
        'bank_name', 'account_holder_name', 'brand',
